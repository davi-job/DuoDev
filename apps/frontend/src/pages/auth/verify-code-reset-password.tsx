...
export function VerifyCodeResetPassword() {
    ...
    async function handleVerify(e: React.FormEvent) {
        ...
        try {
            ...
            navigate('/redefinir-senha', { state: { email, resetToken: code } });
        } catch (error) {
    ...
    return (
        <div className="p-8">
            <div className="flex w-87.5 flex-col justify-center gap-6">
                ...
                >
                    <h1 className="text-2xl tracking-tight text-[#244C4E]">Verificar código</h1>
